---
Title: Little Lemon Recommended Actions Index
...
| AI Chatbot Spotlight | Highlight Gemini-powered assistant across UX and README. | TBD | Not Started | [Plan](./05-ai-chatbot-spotlight-plan.md) |
| Documentation Polish | Refresh README and supporting docs with case studies and metadata. | TBD | Not Started | [Plan](./06-documentation-polish-plan.md) |

# Milestone Tracker
- **Milestone 1** TypeScript foundation in place and passing `tsc --noEmit`.
- **Milestone 2** Playwright flows running locally and in CI with axe scans.
- **Milestone 3** Production deployment live with Lighthouse report published.
- **Milestone 4** README storytelling and chatbot assets finalized.

# Next Updates
- **Immediate** Complete TypeScript conversion plan before starting migration work.
- **Upcoming** Draft Playwright adoption strategy referencing TS types and new CI expectations.
